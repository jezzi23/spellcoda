...
local default_settings     = {
    ...
    overlay_top_y                                               = -3.0,
    overlay_top_fsize                                           = 8,
    overlay_top_selection                                       = "overlay_display_avoid_chance",

    overlay_center_enabled                                      = false,
    overlay_center_x                                            = 0.0,
    overlay_center_y                                            = -1.5,
    overlay_center_fsize                                        = 8,
    overlay_center_selection                                    = "overlay_display_effect_per_cost",

    overlay_bottom_enabled                                      = false,
    overlay_bottom_x                                            = 0.0,
    ...
    overlay_currently_casting_animate                           = true,

    -- Currently casting frame labels
    overlay_currently_casting_outside_right_upper_enabled       = true,
    overlay_currently_casting_outside_right_upper_x             = 0,
    overlay_currently_casting_outside_right_upper_y             = -15,
    overlay_currently_casting_outside_right_upper_fsize         = 13,
    overlay_currently_casting_outside_right_upper_selection     = "overlay_display_direct_normal",

    overlay_currently_casting_outside_right_lower_enabled       = true,
    overlay_currently_casting_outside_right_lower_x             = 0,
    overlay_currently_casting_outside_right_lower_y            = 15,
    overlay_currently_casting_outside_right_lower_fsize         = 13,
    overlay_currently_casting_outside_right_lower_selection     = "overlay_display_direct_crit",

    overlay_currently_casting_outside_left_upper_enabled        = true,
    overlay_currently_casting_outside_left_upper_x              = 0,
    overlay_currently_casting_outside_left_upper_y              = -15,
    overlay_currently_casting_outside_left_upper_fsize          = 13,
    overlay_currently_casting_outside_left_upper_selection      = "overlay_display_ot_normal",

    overlay_currently_casting_outside_left_lower_enabled        = true,
    overlay_currently_casting_outside_left_lower_x              = 0,
    overlay_currently_casting_outside_left_lower_y              = 15,
    overlay_currently_casting_outside_left_lower_fsize          = 13,
    overlay_currently_casting_outside_left_lower_selection      = "overlay_display_ot_crit",

    overlay_currently_casting_outside_top_left_enabled          = true,
    overlay_currently_casting_outside_top_left_x                = -2,
    overlay_currently_casting_outside_top_left_y                = 4,
    overlay_currently_casting_outside_top_left_fsize            = 9,
    overlay_currently_casting_outside_top_left_selection        = "overlay_display_mitigation",

    overlay_currently_casting_outside_top_right_enabled         = true,
    overlay_currently_casting_outside_top_right_x               = 2,
    overlay_currently_casting_outside_top_right_y               = 4,
    overlay_currently_casting_outside_top_right_fsize           = 9,
    overlay_currently_casting_outside_top_right_selection       = "overlay_display_effect_per_sec",

    overlay_currently_casting_outside_bottom_left_enabled       = true,
    overlay_currently_casting_outside_bottom_left_x             = -2,
    overlay_currently_casting_outside_bottom_left_y             = -4,
    overlay_currently_casting_outside_bottom_left_fsize         = 9,
    overlay_currently_casting_outside_bottom_left_selection     = "overlay_display_time_until_oom",

    overlay_currently_casting_outside_bottom_right_enabled      = true,
    overlay_currently_casting_outside_bottom_right_x            = 2,
    overlay_currently_casting_outside_bottom_right_y            = -4,
    overlay_currently_casting_outside_bottom_right_fsize        = 9,
    overlay_currently_casting_outside_bottom_right_selection    = "overlay_display_effect_per_cost",

    overlay_currently_casting_inside_top_enabled                = true,
    overlay_currently_casting_inside_top_x                      = 0,
    overlay_currently_casting_inside_top_y                      = 0,
    overlay_currently_casting_inside_top_fsize                  = 7,
    overlay_currently_casting_inside_top_selection              = "overlay_display_hit_chance",

    overlay_currently_casting_inside_bottom_enabled             = true,
    overlay_currently_casting_inside_bottom_x                   = 0,
    overlay_currently_casting_inside_bottom_y                   = 0,
    overlay_currently_casting_inside_bottom_fsize               = 7,
    overlay_currently_casting_inside_bottom_selection           = "overlay_display_crit_chance",

    overlay_currently_casting_inside_left_enabled               = true,
    overlay_currently_casting_inside_left_x                     = 0,
    overlay_currently_casting_inside_left_y                     = 0,
    overlay_currently_casting_inside_left_fsize                 = 7,
    overlay_currently_casting_inside_left_selection             = "overlay_display_rank",

    overlay_currently_casting_inside_right_enabled              = true,
    overlay_currently_casting_inside_right_x                    = 0,
    overlay_currently_casting_inside_right_y                    = 0,
    overlay_currently_casting_inside_right_fsize                = 7,
    overlay_currently_casting_inside_right_selection            = "overlay_display_avoid_chance",
